...
data class V2rayConfig(
    ...
    /*Aether: read by the app, which runs the Aether core with this command line; Xray ignores the
      key. Only the full configuration of an Aether profile carries it, so it survives an export.*/
